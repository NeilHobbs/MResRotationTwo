...
IR_Survival_Func = function(Kmax, z, n, z_50, nsim){ 
  
  f_z = rnorm(nsim, mean = z) #Generate random distribution around mean IR level, of nsim replicates. 
...
IR_Survival_Func(1, 100, 1, 100, 1000)  #Currently only giving ~0.5 when n = 1
